...
namespace senders
{
    ...
    ssize_t send_trick(int socket_fd, int16_t trick_number, const vector<string>& cards, string& message);
    ssize_t send_wrong(int socket_fd, int16_t trick_number, string& message);
    ssize_t send_taken(int socket_fd, int16_t trick_number, const vector<string>& cards, const string& taking_seat, string& message);
